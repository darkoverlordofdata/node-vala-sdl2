/* Input.c generated by valac 0.36.4-dirty, the Vala compiler
	...
	if (_tmp0_ != NULL) {
		while (TRUE) {
			...
			switch (_tmp4_) {
				...
				{
					{
						...
						if (_tmp8_ <= 255) {
							...
							SDL_Event _tmp11_;
							SDL_KeyboardEvent _tmp12_;
							SDL_Keysym _tmp13_;
							SDL_Keycode _tmp14_;
							guint8 _tmp15_;
							sdxInputProcessor* _tmp16_;
							SDL_Event _tmp17_;
							SDL_KeyboardEvent _tmp18_;
							SDL_Keysym _tmp19_;
							SDL_Keycode _tmp20_;
				...
				{
					{
						...
						if (_tmp24_ <= 255) {
							...
							SDL_Event _tmp27_;
							SDL_KeyboardEvent _tmp28_;
							SDL_Keysym _tmp29_;
							SDL_Keycode _tmp30_;
							guint8 _tmp31_;
							sdxInputProcessor* _tmp32_;
							SDL_Event _tmp33_;
							SDL_KeyboardEvent _tmp34_;
							SDL_Keysym _tmp35_;
							SDL_Keycode _tmp36_;
				...
				{
					{
						sdxInputProcessor* _tmp37_;
						SDL_Event _tmp38_;
						SDL_MouseMotionEvent _tmp39_;
						gint32 _tmp40_;
						SDL_Event _tmp41_;
						SDL_MouseMotionEvent _tmp42_;
						gint32 _tmp43_;
						sdxInputProcessor* _tmp44_;
						SDL_Event _tmp45_;
						SDL_MouseMotionEvent _tmp46_;
						gint32 _tmp47_;
						SDL_Event _tmp48_;
						SDL_MouseMotionEvent _tmp49_;
						gint32 _tmp50_;
				...
				{
					{
						sdxInputProcessor* _tmp51_;
						SDL_Event _tmp52_;
						SDL_MouseMotionEvent _tmp53_;
						gint32 _tmp54_;
						SDL_Event _tmp55_;
						SDL_MouseMotionEvent _tmp56_;
						gint32 _tmp57_;
				...
				{
					{
						sdxInputProcessor* _tmp58_;
						SDL_Event _tmp59_;
						SDL_MouseMotionEvent _tmp60_;
						gint32 _tmp61_;
						SDL_Event _tmp62_;
						SDL_MouseMotionEvent _tmp63_;
						gint32 _tmp64_;
