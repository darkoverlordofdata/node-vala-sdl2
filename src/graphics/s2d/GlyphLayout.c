/* GlyphLayout.c generated by valac 0.36.4-dirty, the Vala compiler
...
sdxgraphicss2dGlyphLayout* sdx_graphics_s2d_glyph_layout_construct (GType object_type, sdxgraphicss2dBitmapFont* font, const gchar* str, sdxgraphicsColor* color, gdouble targetWidth, gdouble halign, gboolean wrap, const gchar* truncate) {
	...
	sdxgraphicss2dBitmapFont* _tmp0_;
	const gchar* _tmp1_;
	const gchar* _tmp2_;
	gint _tmp3_;
	gint _tmp4_;
...
void sdx_graphics_s2d_glyph_layout_setText (sdxgraphicss2dGlyphLayout* self, sdxgraphicss2dBitmapFont* font, const gchar* str, gint start, gint end, sdxgraphicsColor* color, gdouble targetWidth, gdouble halign, gboolean wrap, const gchar* truncate) {
	...
	sdxgraphicss2dBitmapFont* _tmp5_;
	sdxgraphicss2dBitmapFontBitmapFontData* _tmp6_;
	sdxgraphicss2dBitmapFontBitmapFontData* _tmp7_;
	gboolean markupEnabled = FALSE;
	sdxgraphicss2dBitmapFontBitmapFontData* _tmp8_;
	gboolean _tmp9_;
	sdxutilsPool* glyphRunPool = NULL;
	sdxutilsPool* _tmp10_;
	...
	if (_tmp0_ != NULL) {
		...
		gdouble _tmp1_;
		sdxgraphicss2dBitmapFont* _tmp2_;
		sdxgraphicss2dBitmapFontBitmapFontData* _tmp3_;
		gdouble _tmp4_;
		_tmp1_ = targetWidth;
		_tmp2_ = font;
		_tmp3_ = _tmp2_->data;
	...
	glyphRunPool = _tmp10_;
	{
		...
		while (TRUE) {
			...
			gint _tmp20_;
			gpointer _tmp21_;
			sdxutilsPool* _tmp22_;
			sdxgraphicss2dGlyphLayoutGlyphRun* _tmp23_;
			_tmp16_ = _run_index;
	...
	while (TRUE) {
		...
		if (_tmp54_ != (-1)) {
			...
			gboolean _tmp184_;
			gint _tmp199_;
			sdxgraphicsColor* _tmp200_;
			_tmp55_ = runEnd;
			_tmp56_ = runStart;
			if (_tmp55_ != _tmp56_) {
				sdxgraphicss2dGlyphLayoutGlyphRun* run = NULL;
				sdxutilsPool* _tmp57_;
				GObject* _tmp58_;
				sdxgraphicss2dGlyphLayoutGlyphRun* _tmp59_;
				sdxgraphicsColor* _tmp60_;
				sdxgraphicsColor* _tmp61_;
				sdxgraphicsColor* _tmp62_;
				sdxgraphicsColor* _tmp63_;
				sdxgraphicss2dGlyphLayoutGlyphRun* _tmp64_;
				gdouble _tmp65_;
				sdxgraphicss2dGlyphLayoutGlyphRun* _tmp66_;
				gdouble _tmp67_;
				sdxgraphicss2dBitmapFontBitmapFontData* _tmp68_;
				sdxgraphicss2dGlyphLayoutGlyphRun* _tmp69_;
				const gchar* _tmp70_;
				gint _tmp71_;
				gint _tmp72_;
				gboolean _tmp73_;
				sdxgraphicss2dGlyphLayoutGlyphRun* _tmp74_;
				...
				_tmp77_ = _tmp76_;
				if (_tmp77_ == 0) {
					sdxutilsPool* _tmp78_;
					sdxgraphicss2dGlyphLayoutGlyphRun* _tmp79_;
					_tmp78_ = glyphRunPool;
					_tmp79_ = run;
					sdx_utils_pool_free (_tmp78_, (GObject*) _tmp79_);
				} else {
					GeeArrayList* _tmp80_;
					sdxgraphicss2dGlyphLayoutGlyphRun* _tmp81_;
					GeeArrayList* xAdvances = NULL;
					sdxgraphicss2dGlyphLayoutGlyphRun* _tmp82_;
						...
						i = 0;
						{
							...
							while (TRUE) {
								...
								if (_tmp97_) {
									gdouble _tmp103_;
									gdouble* _tmp104_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp105_;
									GeeArrayList* _tmp106_;
									gint _tmp107_;
									gpointer _tmp108_;
									sdxgraphicss2dBitmapFontGlyph* _tmp109_;
									gint _tmp110_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp111_;
									GeeArrayList* _tmp112_;
									gint _tmp113_;
									gpointer _tmp114_;
									sdxgraphicss2dBitmapFontGlyph* _tmp115_;
									gint _tmp116_;
									sdxgraphicss2dBitmapFontBitmapFontData* _tmp117_;
									gdouble _tmp118_;
									gdouble _tmp119_;
									_tmp103_ = x;
									_tmp104_ = xAdvance;
								...
								if (_tmp96_) {
									...
									gint wrapIndex = 0;
									sdxgraphicss2dBitmapFontBitmapFontData* _tmp131_;
									gint _tmp132_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp133_;
									GeeArrayList* _tmp134_;
									gint _tmp135_;
									gboolean _tmp136_ = FALSE;
									gboolean _tmp137_ = FALSE;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp138_;
									gdouble _tmp139_;
									sdxgraphicss2dGlyphLayoutGlyphRun* next = NULL;
									gint _tmp147_;
									gdouble _tmp158_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp159_;
									gdouble _tmp160_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp161_;
									gdouble _tmp162_;
									gdouble _tmp163_;
									gdouble _tmp164_;
									sdxgraphicss2dBitmapFontBitmapFontData* _tmp165_;
									gdouble _tmp166_;
									gint _tmp167_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp168_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp169_;
									gdouble _tmp170_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp171_;
									GeeArrayList* _tmp172_;
									gint _tmp173_;
									gint _tmp174_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp175_;
									GeeArrayList* _tmp176_;
									GeeArrayList* _tmp177_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp178_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp179_;
									_tmp120_ = truncate;
									if (_tmp120_ != NULL) {
										sdxgraphicss2dBitmapFontBitmapFontData* _tmp121_;
										sdxgraphicss2dGlyphLayoutGlyphRun* _tmp122_;
										gdouble _tmp123_;
										const gchar* _tmp124_;
										gint _tmp125_;
										sdxutilsPool* _tmp126_;
										sdxgraphicss2dGlyphLayoutGlyphRun* _tmp127_;
										gdouble _tmp128_;
										sdxgraphicss2dGlyphLayoutGlyphRun* _tmp129_;
										gdouble _tmp130_;
										_tmp121_ = fontData;
										_tmp122_ = run;
									...
									if (_tmp137_) {
										...
										gint _tmp141_;
										sdxgraphicss2dGlyphLayoutGlyphRun* _tmp142_;
									...
									_tmp147_ = wrapIndex;
									if (_tmp147_ == 0) {
										sdxgraphicss2dGlyphLayoutGlyphRun* _tmp148_;
										sdxgraphicss2dGlyphLayoutGlyphRun* _tmp149_;
										_tmp148_ = run;
										_tmp149_ = _g_object_ref0 (_tmp148_);
										_g_object_unref0 (next);
										next = _tmp149_;
									} else {
										sdxgraphicss2dBitmapFontBitmapFontData* _tmp150_;
										sdxgraphicss2dGlyphLayoutGlyphRun* _tmp151_;
										sdxutilsPool* _tmp152_;
										gint _tmp153_;
										gint _tmp154_;
										sdxgraphicss2dGlyphLayoutGlyphRun* _tmp155_;
										GeeArrayList* _tmp156_;
										sdxgraphicss2dGlyphLayoutGlyphRun* _tmp157_;
										_tmp150_ = fontData;
										_tmp151_ = run;
									...
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp180_;
									sdxgraphicss2dGlyphLayoutGlyphRun* _tmp181_;
									gdouble _tmp182_;
									gdouble* _tmp183_;
									_tmp180_ = run;
									_tmp181_ = run;
			...
			if (_tmp184_) {
				...
				gdouble _tmp187_;
				gdouble down = 0.0;
				sdxgraphicss2dBitmapFontBitmapFontData* _tmp188_;
				gdouble _tmp189_;
				gint _tmp190_;
				gint _tmp191_;
				gdouble _tmp197_;
				...
				if (_tmp190_ == _tmp191_) {
					gdouble _tmp192_;
					sdxgraphicss2dBitmapFontBitmapFontData* _tmp193_;
					gdouble _tmp194_;
					gint _tmp195_;
					_tmp192_ = down;
					_tmp193_ = fontData;
...
sdxgraphicss2dGlyphLayoutGlyphRun* sdx_graphics_s2d_glyph_layout_wrap (sdxgraphicss2dGlyphLayout* self, sdxgraphicss2dBitmapFontBitmapFontData* fontData, sdxgraphicss2dGlyphLayoutGlyphRun* first, sdxutilsPool* glyphRunPool, gint wrapIndex, gint widthIndex) {
	...
	sdxgraphicss2dGlyphLayoutGlyphRun* _tmp0_;
	sdxgraphicss2dGlyphLayoutGlyphRun* _tmp1_;
