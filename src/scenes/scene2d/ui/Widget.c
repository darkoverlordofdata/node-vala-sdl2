/* Widget.c generated by valac 0.36.4-dirty, the Vala compiler
...
static void sdx_scenes_scene2d_ui_widget_real_validate (sdxscenesscene2dutilsLayout* base) {
	...
	if (_tmp1_) {
		...
		sdxscenesscene2dStage* _tmp6_;
		sdxscenesscene2dStage* _tmp7_;
		gdouble _tmp28_;
		gdouble _tmp29_;
		parentWidth = 0.0;
		parentHeight = 0.0;
		...
		if (_tmp7_ != NULL) {
			...
			sdxscenesscene2dStage* _tmp10_;
			sdxscenesscene2dStage* _tmp11_;
		...
		if (_tmp5_) {
			...
			sdxscenesscene2dGroup* _tmp22_;
			sdxscenesscene2dGroup* _tmp23_;
			gdouble _tmp24_;
			sdxscenesscene2dGroup* _tmp25_;
			sdxscenesscene2dGroup* _tmp26_;
			gdouble _tmp27_;
